...
export default class chapter_2_1 {
    constructor() {
        ...
        this.c1_embVa2_1 = document.querySelector("#c2_embVal_1")
        this.c1_embVa2_2 = document.querySelector("#c2_embVal_2")
    ...
    SetProblem() {
        ...
        /** 우선순위 증가 시키는 인덱스 범위 */
        this.priorityStandardList_2 = [0, 1]
        ...
        this.inputBoxList_1.forEach((element, index) => {
            let problemCtrl = new ProblemClickController(element, this.problemEmmiter_2)
    ...
    SetProblem2() {
        ...
        this.inputBoxList_2 = this.chapter2.querySelectorAll(".c1_2")
    ...
    Reset() {
        this.ProblemList1.forEach((problem, index) => {
            ...
            if (index <= this.priorityStandardList_2[0]) {
                problem.Activate()
            }
        })
