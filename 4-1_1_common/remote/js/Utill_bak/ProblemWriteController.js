        ...
        this.answerDiv.addEventListener("click", (e) => {
            ...
            if ((this.isMobile || this.isIpad) && this.keyBoardType == "number") {
                ...
                //한글이나 다른 언어일때
                    ...
                    ustomInput.type = "text"; // 타입 설정
                    customInput.inputMode = "text"; 
                    customInput.autocomplete = "off";
                    customInput.style.position = "absolute";
                    customInput.style.opacity = "0.01"; // 약간의 투명도를 주어 보이게 함
                    customInput.style.height = "20px"; // 최소한의 높이 설정
                    customInput.style.width = "20px"; // 최소한의 너비 설정
                    customInput.style.zIndex = "-1"; // 다른 요소와 겹치지 않도록 함
